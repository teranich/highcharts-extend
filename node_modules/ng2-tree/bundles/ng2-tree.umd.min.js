...
(["1"], ["16","8","11"], true, function($__System) {
...
$__System.registerDynamic('7', ['8', '2', '9', 'a', '3', 'b', 'c', 'd', 'e', '4', '5', '6'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var tree_types_1 = $__require('2');
    var node_draggable_service_1 = $__require('9');
    var node_menu_service_1 = $__require('a');
    var draggable_types_1 = $__require('3');
    var menu_types_1 = $__require('b');
    var editable_type_1 = $__require('c');
    var tree_service_1 = $__require('d');
    var event_utils_1 = $__require('e');
    var _ = $__require('4');
    var type_utils_1 = $__require('5');
    var tree_styles_1 = $__require('6');
    var TreeInternalComponent = function () {
        ...
        TreeInternalComponent.prototype.setUpNodeSelectedEventHandler = function () {
            var _this = this;
            this.treeService.nodeSelected$.filter(function (e) {
                return _this.tree !== e.node;
            }).subscribe(function () {
        ...
        TreeInternalComponent.prototype.setUpMenuEventHandler = function () {
            var _this = this;
            this.nodeMenuService.nodeMenuEvents$.filter(function (e) {
                return _this.element.nativeElement !== e.sender;
            }).filter(function (e) {
                return e.action === menu_types_1.NodeMenuAction.Close;
            }).subscribe(function () {
                return _this.isMenuVisible = false;
            });
        };
        TreeInternalComponent.prototype.setUpDraggableEventHandler = function () {
            var _this = this;
            this.nodeDraggableService.draggableNodeEvents$.filter(function (e) {
                return e.action === draggable_types_1.NodeDraggableEventAction.Remove;
            }).filter(function (e) {
                return e.captured.element === _this.element;
            }).subscribe(function (e) {
                return _this.onChildRemoved({ node: e.captured.tree }, _this.parentTree);
            });
            this.nodeDraggableService.draggableNodeEvents$.filter(function (e) {
                return e.action !== draggable_types_1.NodeDraggableEventAction.Remove;
            }).filter(function (e) {
                ...
                return !_this.hasChild(e.captured.tree);
            }).subscribe(function (e) {
        ...
        TreeInternalComponent.prototype.isEditInProgress = function () {
            return this.tree._status === tree_types_1.TreeStatus.EditInProgress || this.tree._status === tree_types_1.TreeStatus.New;
        };
        ...
        TreeInternalComponent.prototype.onChildRemoved = function (e, parent) {
            ...
            var childIndex = _.findIndex(parent.children, function (child) {
                return child === e.node;
            });
            if (childIndex >= 0) {
        ...
        TreeInternalComponent.ctorParameters = [{ type: node_menu_service_1.NodeMenuService, decorators: [{ type: core_1.Inject, args: [node_menu_service_1.NodeMenuService] }] }, { type: node_draggable_service_1.NodeDraggableService, decorators: [{ type: core_1.Inject, args: [node_draggable_service_1.NodeDraggableService] }] }, { type: tree_service_1.TreeService, decorators: [{ type: core_1.Inject, args: [tree_service_1.TreeService] }] }, { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef] }] }];
    ...
    var TreeComponent = function () {
        ...
        TreeComponent.ctorParameters = [{ type: tree_service_1.TreeService, decorators: [{ type: core_1.Inject, args: [tree_service_1.TreeService] }] }];
...
$__System.registerDynamic('10', ['8', '9', 'f'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var core_1 = $__require('8');
    var node_draggable_service_1 = $__require('9');
    var captured_node_1 = $__require('f');
...
$__System.registerDynamic('9', ['8', '11'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var NodeDraggableService = function () {
        ...
        NodeDraggableService.ctorParameters = [];
...
$__System.registerDynamic('12', ['8', 'c'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var NodeEditableDirective = function () {
        ...
        NodeEditableDirective.ctorParameters = [{ type: core_1.Renderer, decorators: [{ type: core_1.Inject, args: [core_1.Renderer] }] }, { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef] }] }];
...
$__System.registerDynamic('14', ['8', 'a', 'b', 'e', '13'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var menu_types_1 = $__require('b');
    var event_utils_1 = $__require('e');
    var node_menu_styles_1 = $__require('13');
    var NodeMenuComponent = function () {
        ...
        NodeMenuComponent.ctorParameters = [{ type: core_1.Renderer, decorators: [{ type: core_1.Inject, args: [core_1.Renderer] }] }, { type: node_menu_service_1.NodeMenuService, decorators: [{ type: core_1.Inject, args: [node_menu_service_1.NodeMenuService] }] }];
...
$__System.registerDynamic('a', ['8', '11'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var NodeMenuService = function () {
        ...
        NodeMenuService.ctorParameters = [];
...
$__System.registerDynamic('d', ['11', '8'], true, function ($__require, exports, module) {
    "use strict";
...
$__System.registerDynamic('15', ['8', '7', '16', '10', '9', '12', '14', 'a', 'd'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var define,
        ...
        GLOBAL = global;
    var core_1 = $__require('8');
    var tree_component_1 = $__require('7');
    var common_1 = $__require('16');
    var node_draggable_directive_1 = $__require('10');
    var node_draggable_service_1 = $__require('9');
    var node_editable_directive_1 = $__require('12');
    var node_menu_component_1 = $__require('14');
    var node_menu_service_1 = $__require('a');
    var tree_service_1 = $__require('d');
...
$__System.registerDynamic('1', ['7', '15'], true, function ($__require, exports, module) {
  "use strict";
  ...
  var tree_module_1 = $__require('15');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["@angular/common","@angular/core","rxjs/Rx"], factory);
